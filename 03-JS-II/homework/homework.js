...
function fizzBuzz(numero) {
  ...
  if((Math.floor(numero/3)==numero/3)&&(Math.floor(numero/5)==numero/5)){return "fizzbuzz";}
  if(Math.floor(numero/3)==numero/3){return "fizz";}
  if(Math.floor(numero/5)==numero/5){return "buzz";}
  return numero;
}
